      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Craft<span
                class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="GlassC.php">GlassC Craft</a></li>
...
$sql = "SELECT * FROM uploadacralic where category = 'ColorLandscape' AND status !='sold'";
$sth = $db->query($sql);
echo '<div class="con5">';
echo '<div class="container">';
if ($sth->num_rows > 0) {
while($row = $sth->fetch_assoc()) {
echo '<form action="LandscapeC.php?id='.$row['id'].'" method="POST">';
echo '<div class="col">';
