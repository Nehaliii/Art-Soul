    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Craft<span
                class="caret"></span></a>
            <ul class="dropdown-menu">
...
echo '<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Details<span
   ...
   <div class="main">
    <img src="Images/craft.jpg" height="50%" width="100%">
  </div>
  <?php

$db = mysqli_connect("localhost","root","","artandsoul"); 
$sql = "SELECT * FROM uploadacralic where category = 'GlassCraft' AND status !='sold'";
$sth = $db->query($sql);
echo '<div class="con5">';
echo '<div class="container">';
if ($sth->num_rows > 0) {
while($row = $sth->fetch_assoc()) {
echo '<form action="GlassC.php?id='.$row['id'].'" method="POST">';
echo '<div class="col">';
