...
$sql = "SELECT id,artist_name,email_id, phone_no,address FROM artist";
...
<div class="container">
    ...
    <table width='100%' border="0">
        ...
        while($res = mysqli_fetch_array($result)) {         
            ...
            echo "<td>".$res['artist_name']."</td>";
            echo "<td>".$res['phone_no']."</td>";
            echo "<td>".$res['email_id']."</td>";  
			echo "<td>".$res['address']."</td>";  			
              if (isset($_SESSION['emaa'])) {
 echo "<td><a href=\"editartist.php?id=$res[id]\">Edit</a> | <a href=\"deleteartist.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
        }
		}
        ?>
    </table>
