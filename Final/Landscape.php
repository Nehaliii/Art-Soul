    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Pencil<span
                class="caret"></span></a>
            <ul class="dropdown-menu">
...
echo '<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Details<span
 ...
 <img src="Images/pencil.jpg" height="50%" width="100%">          
      </div>
...
$sql = "SELECT * FROM uploadacralic where category = 'Landscape' AND status !='sold'";
$sth = $db->query($sql);
echo '<div class="con5">';
echo '<div class="container">';
if ($sth->num_rows > 0) {
while($row = $sth->fetch_assoc()) {
echo '<form action="Landscape.php?id='.$row['id'].'" method="POST">';
echo '<div class="col">';
